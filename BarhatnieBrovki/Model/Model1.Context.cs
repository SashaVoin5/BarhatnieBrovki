...
namespace BarhatnieBrovki.Model
{
    ...
    public partial class BarhatnieBrovkiEntities : DbContext
    {
        private static BarhatnieBrovkiEntities context;
        public BarhatnieBrovkiEntities()
            : base("name=BarhatnieBrovkiEntities")
        {
        }
