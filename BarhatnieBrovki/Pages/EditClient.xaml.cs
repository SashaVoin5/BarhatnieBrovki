...
namespace BarhatnieBrovki.Pages
{
    ...
    public partial class EditClient : Page
    {
        ...
        public EditClient(Client client)
        {
            ...
            var tag = BarhatnieBrovkiEntities.GetContext().Tag;
            ...
            var Gen = BarhatnieBrovkiEntities.GetContext().Gender.Where(GENDER => GENDER.Code == genCode);
            ...
            TagGrid.ItemsSource = BarhatnieBrovkiEntities.GetContext().TagOfClient.Where(ProductSale => ProductSale.ClientID == cl.ID).ToList();
        }
        ...
        private void AddImage_click(object sender, RoutedEventArgs e)
        {
            ...
            OFD.InitialDirectory = "C:\\Users\\sasha\\source\\repos\\BarhatnieBrovki\\BarhatnieBrovki\\Resources\\"; //Сюда будут сохраняться все фотографии
        ...
        private void AddTag_Click(object sender, RoutedEventArgs e)
        {
            ...
            var SelectedTagID = BarhatnieBrovkiEntities.GetContext().Tag.Where(p => p.Title == TagName).FirstOrDefault();
            ...
            try
            {
                ...
                BarhatnieBrovkiEntities.GetContext().TagOfClient.Add(newTag);
                BarhatnieBrovkiEntities.GetContext().SaveChanges();
                TagGrid.ItemsSource = BarhatnieBrovkiEntities.GetContext().TagOfClient.Where(p => p.ClientID == cl.ID).ToList();
            }
            catch { }
        ...
        private void DeleteTag_Click(object sender, RoutedEventArgs e)
        {
            for (int i = 0; i < TagGrid.SelectedItems.Count; i++)
            {
                ...
                if (prs != null)
                {
                    BarhatnieBrovkiEntities.GetContext().TagOfClient.Remove(prs);
                }
            }
            try
            {
